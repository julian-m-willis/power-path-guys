  ...
  return (
    <div style={{ backgroundColor: "#1a1a1a", color: "#39FF14", minHeight: "100vh" }}>
      ...
      <div ref={heroRef} className="flex flex-col items-center justify-center py-10 px-4 text-center">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-6">Kickstart Your Fitness Journey</h1>
        ...
        <Link href="/auth/register">
          <button
            className="bg-[#39FF14] text-black font-bold py-3 px-8 rounded-full shadow-lg hover:bg-[#2ecc71] hover:text-white transition duration-300 focus:bg-[#2ecc71] focus:text-white"
          >
            Get Started
          </button>
        </Link>
      ...
      <div ref={ctaRef} className="flex flex-col items-center py-10">
        ...
        <div className="space-x-4">
          ...
          <Link href="/auth/signin">
            <button
              className="bg-black text-[#39FF14] font-bold py-3 px-8 rounded-full shadow-lg border-2 border-[#39FF14] hover:bg-[#2ecc71] hover:text-white transition duration-300 focus:bg-[#2ecc71] focus:text-white"
            >
              Sign In
            </button>
          </Link>
