...
export default function AdditionalInfoPage() {
  ...
  return (
    <div
      className="flex flex-col h-screen bg-cover bg-center px-10"
      style={{ backgroundImage: "url('/Power path guys (2).jpg')" }}
    >
      <style>
        {`
      ...
      <div className="flex flex-col items-start justify-center h-full pl-40">
        <h1 className="text-5xl font-bold mb-6" style={{ color: "#c1ff72" }}>
        ...
        >
          ...
          <button
            ...
            className="text-m font-bold text-black bg-[#c1ff72] py-2 px-6 mt-4"
            style={{ width: "120px" }}
          >
            Submit
          </button>
